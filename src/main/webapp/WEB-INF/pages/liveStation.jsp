<html>
    ...
    <body>
            ...
            <div class="login">
                ...
                <p class="description">Live Station</p>

                <form autocomplete="off" action="/action_page.php">
                  <div class="autocomplete" style="width:300px;">
                    <input id="source-station" type="text" name="station_name" placeholder="Station"><br><br>
                    <input id="destination-station" type="text"name="dest_name" placeholder="Going to (Optional)"><br>
                  </div>
                </form>
    ...
    <script>
        ...
        $("#btn-findTrains").click(function(){
            ...
            if(isFormValid){
                ...
                $.ajax({
                    type: "POST",
                    url: "/user/live_station",
                    data: JSON.stringify(journey),
                    success: function(response){
                        if(!!response){
                            location.href = "/user/results_live_station";
                        }
                    },
